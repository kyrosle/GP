...
*/
  ...
  public:
    ...
    */
    ...
    Matrix4x4(const Vector4 &row0, const Vector4 &row1, const Vector4 &row2,
              const Vector4 &row3) {
      m_mat[0][0] = row0.x;
      m_mat[0][1] = row0.y;
      m_mat[0][2] = row0.z;
    ...
    Matrix4x4(const Vector3 &position, const Vector3 &scale,
     ...
     * from a rotation/scaling 3x3 matrix.
     */
    ...
    Matrix4x4 concatenate(const Matrix4x4 &m2) const {
      ...
      r.m_mat[0][0] = m_mat[0][0] * m2.m_mat[0][0] +
                      m_mat[0][1] * m2.m_mat[1][0] +
                      m_mat[0][2] * m2.m_mat[2][0] +
                      m_mat[0][3] * m2.m_mat[3][0];
      r.m_mat[0][1] = m_mat[0][0] * m2.m_mat[0][1] +
                      m_mat[0][1] * m2.m_mat[1][1] +
                      m_mat[0][2] * m2.m_mat[2][1] +
                      m_mat[0][3] * m2.m_mat[3][1];
      r.m_mat[0][2] = m_mat[0][0] * m2.m_mat[0][2] +
                      m_mat[0][1] * m2.m_mat[1][2] +
                      m_mat[0][2] * m2.m_mat[2][2] +
                      m_mat[0][3] * m2.m_mat[3][2];
      r.m_mat[0][3] = m_mat[0][0] * m2.m_mat[0][3] +
                      m_mat[0][1] * m2.m_mat[1][3] +
                      m_mat[0][2] * m2.m_mat[2][3] +
                      m_mat[0][3] * m2.m_mat[3][3];

      r.m_mat[1][0] = m_mat[1][0] * m2.m_mat[0][0] +
                      m_mat[1][1] * m2.m_mat[1][0] +
                      m_mat[1][2] * m2.m_mat[2][0] +
                      m_mat[1][3] * m2.m_mat[3][0];
      r.m_mat[1][1] = m_mat[1][0] * m2.m_mat[0][1] +
                      m_mat[1][1] * m2.m_mat[1][1] +
                      m_mat[1][2] * m2.m_mat[2][1] +
                      m_mat[1][3] * m2.m_mat[3][1];
      r.m_mat[1][2] = m_mat[1][0] * m2.m_mat[0][2] +
                      m_mat[1][1] * m2.m_mat[1][2] +
                      m_mat[1][2] * m2.m_mat[2][2] +
                      m_mat[1][3] * m2.m_mat[3][2];
      r.m_mat[1][3] = m_mat[1][0] * m2.m_mat[0][3] +
                      m_mat[1][1] * m2.m_mat[1][3] +
                      m_mat[1][2] * m2.m_mat[2][3] +
                      m_mat[1][3] * m2.m_mat[3][3];

      r.m_mat[2][0] = m_mat[2][0] * m2.m_mat[0][0] +
                      m_mat[2][1] * m2.m_mat[1][0] +
                      m_mat[2][2] * m2.m_mat[2][0] +
                      m_mat[2][3] * m2.m_mat[3][0];
      r.m_mat[2][1] = m_mat[2][0] * m2.m_mat[0][1] +
                      m_mat[2][1] * m2.m_mat[1][1] +
                      m_mat[2][2] * m2.m_mat[2][1] +
                      m_mat[2][3] * m2.m_mat[3][1];
      r.m_mat[2][2] = m_mat[2][0] * m2.m_mat[0][2] +
                      m_mat[2][1] * m2.m_mat[1][2] +
                      m_mat[2][2] * m2.m_mat[2][2] +
                      m_mat[2][3] * m2.m_mat[3][2];
      r.m_mat[2][3] = m_mat[2][0] * m2.m_mat[0][3] +
                      m_mat[2][1] * m2.m_mat[1][3] +
                      m_mat[2][2] * m2.m_mat[2][3] +
                      m_mat[2][3] * m2.m_mat[3][3];

      r.m_mat[3][0] = m_mat[3][0] * m2.m_mat[0][0] +
                      m_mat[3][1] * m2.m_mat[1][0] +
                      m_mat[3][2] * m2.m_mat[2][0] +
                      m_mat[3][3] * m2.m_mat[3][0];
      r.m_mat[3][1] = m_mat[3][0] * m2.m_mat[0][1] +
                      m_mat[3][1] * m2.m_mat[1][1] +
                      m_mat[3][2] * m2.m_mat[2][1] +
                      m_mat[3][3] * m2.m_mat[3][1];
      r.m_mat[3][2] = m_mat[3][0] * m2.m_mat[0][2] +
                      m_mat[3][1] * m2.m_mat[1][2] +
                      m_mat[3][2] * m2.m_mat[2][2] +
                      m_mat[3][3] * m2.m_mat[3][2];
      r.m_mat[3][3] = m_mat[3][0] * m2.m_mat[0][3] +
                      m_mat[3][1] * m2.m_mat[1][3] +
                      m_mat[3][2] * m2.m_mat[2][3] +
    ...
    */
    Vector3 operator*(const Vector3 &v) const {
      ...
      float inv_w = 1.0f / (m_mat[3][0] * v.x + m_mat[3][1] * v.y +
                            m_mat[3][2] * v.z + m_mat[3][3]);

      r.x = (m_mat[0][0] * v.x + m_mat[0][1] * v.y + m_mat[0][2] * v.z +
             m_mat[0][3]) *
            inv_w;
      r.y = (m_mat[1][0] * v.x + m_mat[1][1] * v.y + m_mat[1][2] * v.z +
             m_mat[1][3]) *
            inv_w;
      r.z = (m_mat[2][0] * v.x + m_mat[2][1] * v.y + m_mat[2][2] * v.z +
             m_mat[2][3]) *
            inv_w;
    ...
    Vector4 operator*(const Vector4 &v) const {
      return Vector4(m_mat[0][0] * v.x + m_mat[0][1] * v.y + m_mat[0][2] * v.z +
                     m_mat[0][3] * v.w,
                     m_mat[1][0] * v.x + m_mat[1][1] * v.y + m_mat[1][2] * v.z +
                     m_mat[1][3] * v.w,
                     m_mat[2][0] * v.x + m_mat[2][1] * v.y + m_mat[2][2] * v.z +
                     m_mat[2][3] * v.w,
                     m_mat[3][0] * v.x + m_mat[3][1] * v.y + m_mat[3][2] * v.z +
                     m_mat[3][3] * v.w);
    }
    ...
    Matrix4x4 operator*(float scalar) const {
      return Matrix4x4(
        scalar * m_mat[0][0], scalar * m_mat[0][1], scalar * m_mat[0][2],
        scalar * m_mat[0][3], scalar * m_mat[1][0], scalar * m_mat[1][1],
        scalar * m_mat[1][2], scalar * m_mat[1][3], scalar * m_mat[2][0],
        scalar * m_mat[2][1], scalar * m_mat[2][2], scalar * m_mat[2][3],
        scalar * m_mat[3][0], scalar * m_mat[3][1], scalar * m_mat[3][2],
        scalar * m_mat[3][3]);
    }
    ...
    bool operator==(const Matrix4x4 &m2) const {
      return !(m_mat[0][0] != m2.m_mat[0][0] || m_mat[0][1] != m2.m_mat[0][1] ||
               m_mat[0][2] != m2.m_mat[0][2] || m_mat[0][3] != m2.m_mat[0][3] ||
               m_mat[1][0] != m2.m_mat[1][0] || m_mat[1][1] != m2.m_mat[1][1] ||
               m_mat[1][2] != m2.m_mat[1][2] || m_mat[1][3] != m2.m_mat[1][3] ||
               m_mat[2][0] != m2.m_mat[2][0] || m_mat[2][1] != m2.m_mat[2][1] ||
               m_mat[2][2] != m2.m_mat[2][2] || m_mat[2][3] != m2.m_mat[2][3] ||
               m_mat[3][0] != m2.m_mat[3][0] || m_mat[3][1] != m2.m_mat[3][1] ||
               m_mat[3][2] != m2.m_mat[3][2] || m_mat[3][3] != m2.m_mat[3][3]);
    }
    ...
    //-----------------------------------------------------------------------
    float getMinor(size_t r0, size_t r1, size_t r2, size_t c0, size_t c1,
                   size_t c2) const {
      return m_mat[r0][c0] *
             (m_mat[r1][c1] * m_mat[r2][c2] - m_mat[r2][c1] * m_mat[r1][c2]) -
             m_mat[r0][c1] *
             (m_mat[r1][c0] * m_mat[r2][c2] - m_mat[r2][c0] * m_mat[r1][c2]) +
             m_mat[r0][c2] *
             (m_mat[r1][c0] * m_mat[r2][c1] - m_mat[r2][c0] * m_mat[r1][c1]);
    }
    ...
    */
    ...
    Matrix4x4 buildViewportMatrix(uint32_t width, uint32_t height) {
      return Matrix4x4(0.5f * (float) width, 0.0f, 0.0f, 0.5f * (float) width,
                       0.0f,
                       -0.5f * (float) height, 0.0f, 0.5f * (float) height,
                       0.0f,
    ...
    */
    ...
    bool hasScale() const {
      ...
      float t = m_mat[0][0] * m_mat[0][0] + m_mat[1][0] * m_mat[1][0] +
                m_mat[2][0] * m_mat[2][0];
      if (!Math::realEqual(t, 1.0, (float) 1e-04))
        return true;
      t = m_mat[0][1] * m_mat[0][1] + m_mat[1][1] * m_mat[1][1] +
          m_mat[2][1] * m_mat[2][1];
      if (!Math::realEqual(t, 1.0, (float) 1e-04))
        return true;
      t = m_mat[0][2] * m_mat[0][2] + m_mat[1][2] * m_mat[1][2] +
          m_mat[2][2] * m_mat[2][2];
    ...
    @remarks
    Transform is performed in the order scale, rotate, translation, i.e.
    translation is independent of orientation axes, scale does not affect size of
    translation, rotation and scaling are always centered on the origin.
    */
    ...
    @remarks
    As makeTransform except it build the inverse given the same data as
    makeTransform, so performing -translation, -rotate, 1/scale in that order.
    */
    ...
    void
    decompositionWithoutScale(Vector3 &position, Quaternion &rotation) const;
    ...
    */
    bool isAffine(void) const {
      return m_mat[3][0] == 0 && m_mat[3][1] == 0 && m_mat[3][2] == 0 &&
             m_mat[3][3] == 1;
    }
    ...
    */
    Matrix4x4 concatenateAffine(const Matrix4x4 &m2) const {
      ...
      return Matrix4x4(
        m_mat[0][0] * m2.m_mat[0][0] + m_mat[0][1] * m2.m_mat[1][0] +
        m_mat[0][2] * m2.m_mat[2][0],
        m_mat[0][0] * m2.m_mat[0][1] + m_mat[0][1] * m2.m_mat[1][1] +
        m_mat[0][2] * m2.m_mat[2][1],
        m_mat[0][0] * m2.m_mat[0][2] + m_mat[0][1] * m2.m_mat[1][2] +
        m_mat[0][2] * m2.m_mat[2][2],
        m_mat[0][0] * m2.m_mat[0][3] + m_mat[0][1] * m2.m_mat[1][3] +
        m_mat[0][2] * m2.m_mat[2][3] + m_mat[0][3],

        m_mat[1][0] * m2.m_mat[0][0] + m_mat[1][1] * m2.m_mat[1][0] +
        m_mat[1][2] * m2.m_mat[2][0],
        m_mat[1][0] * m2.m_mat[0][1] + m_mat[1][1] * m2.m_mat[1][1] +
        m_mat[1][2] * m2.m_mat[2][1],
        m_mat[1][0] * m2.m_mat[0][2] + m_mat[1][1] * m2.m_mat[1][2] +
        m_mat[1][2] * m2.m_mat[2][2],
        m_mat[1][0] * m2.m_mat[0][3] + m_mat[1][1] * m2.m_mat[1][3] +
        m_mat[1][2] * m2.m_mat[2][3] + m_mat[1][3],

        m_mat[2][0] * m2.m_mat[0][0] + m_mat[2][1] * m2.m_mat[1][0] +
        m_mat[2][2] * m2.m_mat[2][0],
        m_mat[2][0] * m2.m_mat[0][1] + m_mat[2][1] * m2.m_mat[1][1] +
        m_mat[2][2] * m2.m_mat[2][1],
        m_mat[2][0] * m2.m_mat[0][2] + m_mat[2][1] * m2.m_mat[1][2] +
        m_mat[2][2] * m2.m_mat[2][2],
    ...
    */
    Vector3 transformAffine(const Vector3 &v) const {
      ...
      return Vector3(
        m_mat[0][0] * v.x + m_mat[0][1] * v.y + m_mat[0][2] * v.z + m_mat[0][3],
    ...
    */
    ...
    Matrix4x4 inverse() const {
      ...
      float m20 = m_mat[2][0], m21 = m_mat[2][1], m22 = m_mat[2][2],
        m23 = m_mat[2][3];
      float m30 = m_mat[3][0], m31 = m_mat[3][1], m32 = m_mat[3][2],
        m33 = m_mat[3][3];
      ...
      return Matrix4x4(d00, d01, d02, d03, d10, d11, d12, d13, d20, d21, d22,
                       d23,
                       d30, d31, d32, d33);
    }
