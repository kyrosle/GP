...
//-----------------------------------------------------------------------
  ...
  Matrix4x4 Math::makeViewMatrix(const Vector3 &position,
  ...
  Matrix4x4 Math::makePerspectiveMatrix(Radian fovy, float aspect, float znear,
                                        float zfar) {
  ...
  Matrix4x4 Math::makeOrthographicProjectionMatrix(float left, float right,
  ...
  Matrix4x4 Math::makeOrthographicProjectionMatrix01(float left, float right,
                                                     float bottom, float top,
                                                     float znear, float zfar) {
    float inv_width = 1.0f / (right - left);
    float inv_height = 1.0f / (top - bottom);
