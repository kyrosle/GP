...
//-----------------------------------------------------------------------
  ...
  Quaternion Quaternion::getQuaternionFromAngleAxis(const Radian &angle,
                                                    const Vector3 &axis) {
    Quaternion q;
  ...
  void Quaternion::fromDirection(const Vector3 &direction,
  ...
  Quaternion Quaternion::getQuaternionFromDirection(const Vector3 &direction,
                                                    const Vector3 &up_direction) {
...
//-----------------------------------------------------------------------
  ...
  Quaternion Quaternion::sLerp(float t, const Quaternion &kp,
                               const Quaternion &kq, bool shortest_path) {
  ...
  Quaternion Quaternion::nLerp(float t, const Quaternion &kp,
                               const Quaternion &kq, bool shortest_path) {
    Quaternion result;
